        ...
        <div className="flex justify-between items-center px-6 py-3 border-b">
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white rounded px-4 py-2 mr-5"
            >
              <CircleUser /> Login
            </Button>

            <img src={vikshitBharat} alt="Internship Logo" className="h-12" />
